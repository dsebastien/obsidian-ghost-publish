...
// Read manifest.json to get the plugin id (the folder Obsidian expects to
// load the plugin from; this is NOT the same as package.json "name" since
// the community catalog forbids the "obsidian-" prefix in manifest ids).
