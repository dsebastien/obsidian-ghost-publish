...
```bash
git clone https://github.com/dsebastien/obsidian-ghost-publish.git
cd obsidian-ghost-publish
```
...
If you prefer not to use the environment variable, manually copy these files to `<YourVault>/.obsidian/plugins/ghost-publish/`:
...
- Check that files exist in `<vault>/.obsidian/plugins/ghost-publish/`
- Restart Obsidian
